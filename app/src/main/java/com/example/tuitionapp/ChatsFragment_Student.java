...
public class ChatsFragment_Student extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_chats_fragment__student, container, false);
    ...
    private void readChats(){
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Users").child("Teacher");
